...
public class UserDao extends AbstractDao<User> {
    ...
    private static final String UPDATE_USER_QUERY = "update User set name =:" + UserConstant.NAME +
            ", lastName =:" + UserConstant.LAST_NAME +
            ", email =:" + UserConstant.EMAIL +
            ", login =:" + UserConstant.LOGIN +
            ", password =:" + UserConstant.PASSWORD +
            ", blocked =:" + UserConstant.BLOCKED +
            ", role =:" + UserConstant.ROLE +
            " where id =:" + UserConstant.ID;
    ...
    private static final String FIND_ALL_USERS_SORTING_BY_NAME = "FROM User WHERE role =:" + UserConstant.ROLE + " order by " + UserConstant.NAME + " ASC";
    private static final String FIND_ALL_USERS_SORTING_BY_EMAIL = "FROM User WHERE role =:" + UserConstant.ROLE + " order by " + UserConstant.EMAIL + " ASC";
    //// ADMIN Query ////
    ...
    private static final String FIND_ALL_SORTING_BY_EMAIL_FOR_ADMIN = "FROM User order by " + UserConstant.EMAIL + " ASC";
    ...
    public Optional<User> findByLoginAndPassword(String login, String password) throws DaoException {
        ...
        System.out.println("findByLoginAndPassword: " + login + " : " + password + " : " + encryptedPassword + " UserDao");
    ...
    public Optional<User> findByEmail(String email) throws DaoException {
        ArgumentValidator.checkForNullOrEmptyString(email, "Not allow for null or empty value in findByEmail " +
                "method at userDao Class");
