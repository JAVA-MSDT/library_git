...
public class BeanNameHolder {
    ...
    public static final String ABSTRACT_DAO = "abstractDao";
    public static final String VIEW_RESOLVER_BEAN = "viewResolver";
    ...
    public static final String ENTITY_MANAGER_BEAN = "entityManager";
