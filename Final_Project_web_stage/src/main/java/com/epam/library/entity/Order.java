...
public class Order {
    ...
    @JoinTable(name = "order_books",
            joinColumns = @JoinColumn(name = OrderConstant.ORDER_ID),
            inverseJoinColumns = @JoinColumn(name = BookConstant.BOOK_ID))
    ...
    public Order(long orderId, Set<Book> bookId, User userId, Date orderDate, Date returningDate, ReadingPlace readingPlace) {
        setOrderId(orderId);
        setBook(bookId);
        setUser(userId);
        setOrderDate(orderDate);
    ...
    public Order(Set<Book> bookId, User userId, Date orderDate, Date returningDate, ReadingPlace readingPlace, boolean bookReturned) {
        setBook(bookId);
        setUser(userId);
        setOrderDate(orderDate);
        setReturningDate(returningDate);
    ...
    // For Testing
    public Order(long orderId, User userId, Date orderDate, Date returningDate, ReadingPlace readingPlace, boolean bookReturned) {
        setOrderId(orderId);
        setUser(userId);
        setOrderDate(orderDate);
        setReturningDate(returningDate);
