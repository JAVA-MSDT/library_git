...
public class UserOrderDisplay {
	...
	public boolean equals(Object o) {
		...
		return id == orderDisplay.id && userId == orderDisplay.userId && bookReturned == orderDisplay.bookReturned
				&& Objects.equals(bookName, orderDisplay.bookName) && Objects.equals(orderDate, orderDisplay.orderDate)
	...
	public String toString() {
		return "UserOrderDisplay{" + "id=" + id + ", userId=" + userId + ", bookName='" + bookName + '\''
				+ ", orderDate=" + orderDate + ", returningDate=" + returningDate + ", readingPlace=" + readingPlace
